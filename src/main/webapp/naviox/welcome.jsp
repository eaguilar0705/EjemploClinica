...
In FacturacionClinica-labels_en.properties:
FacturacionClinica=My application
FacturacionClinica[description]=My application does this and that

In FacturacionClinica-messages_en.properties:
